...
<%--搜索框--%>
<h1 style="text-align: center ;margin: 30px auto;width: 400px">宠物管理</h1>
...
<div style="align-content: center;width: 800px; margin: 10px auto">
    ...
    <a href="findMyPets?pageCode=${pageBean.allPages }">
